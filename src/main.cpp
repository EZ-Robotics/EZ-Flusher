...
void initialize() {
  ...
  chassis.opcontrol_curve_buttons_toggle(curve_buttons_toggle);
  chassis.opcontrol_drive_activebrake_set(active_brake_constant);
  if (!pros::usd::is_installed()) chassis.opcontrol_curve_default_set(drive_curve_constants.first, drive_curve_constants.second);
